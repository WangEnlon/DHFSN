...
def _train(model, args):
    ...
    dataloader = train_dataloader(args.data_dir, args.batch_size, args.num_worker, dataset_type=args.dataset)
    ...
    for epoch_idx in range(epoch, args.num_epoch + 1):
        ...
        for iter_idx, batch_data in enumerate(tqdm(dataloader)):
            ...
            del input_img, label_img, pred_img, label_img2, label_img4
            loss.backward()
